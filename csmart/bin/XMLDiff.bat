...
REM Main script to run XMLDiff
...
REM Start XMLDiff using Bootstrapper
...
java.exe %MYPROPERTIES% %MYCONFIGPATH% -classpath %MYCLASSPATH% org.cougaar.bootstrap.Bootstrapper org.cougaar.tools.csmart.ui.xmldiffl.XMLDiff
