...
(vq "select * from V4_ASB_component_arg a where assembly_id like '%S T%' and not exists (select assembly_id from V4_ASB_component_arg b where assembly_id like '%A-7%' and a.component_alib_id=b.component_alib_id and a.argument=b.argument)")
(vq "select * from V4_ASB_component_arg a where assembly_id like '%A-7%' and not exists (select assembly_id from V4_ASB_component_arg b where assembly_id like '%S T%' and a.component_alib_id=b.component_alib_id and a.argument=b.argument)")
(vq "select * from V4_ASB_component_hierarchy a where assembly_id like '%A-7%' and not exists (select assembly_id from V4_ASB_component_hierarchy b where assembly_id like '%S T%' and a.component_alib_id=b.component_alib_id and a.parent_component_alib_id=b.parent_component_alib_id)")
(vq "select * from V4_ASB_component_hierarchy a where assembly_id like '%S T%' and not exists (select assembly_id from V4_ASB_component_hierarchy b where assembly_id like '%A-7%'  and a.component_alib_id=b.component_alib_id and a.parent_component_alib_id=b.parent_component_alib_id)")
