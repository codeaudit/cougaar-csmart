...
REM Load the Configuration data contained in csmart/data/database/new/csv
...
COPY %COUGAAR_INSTALL_PATH%\csmart\data\database\new\scripts\noncsmart-db.drop-mysql-tables.sql %COUGAAR_INSTALL_PATH%\csmart\data\database\new\scripts\dropTab.sql
COPY %COUGAAR_INSTALL_PATH%\csmart\data\database\new\scripts\noncsmart-db.create-mysql-tables.sql %COUGAAR_INSTALL_PATH%\csmart\data\database\new\scripts\creatTab.sql
COPY %COUGAAR_INSTALL_PATH%\csmart\data\database\new\scripts\noncsmart-db.load-mysql-tables.sql %COUGAAR_INSTALL_PATH%\csmart\data\database\scripts\mysql\sql\loadTab.sql
COPY %COUGAAR_INSTALL_PATH%\csmart\data\database\new\scripts\noncsmart-db.create-mysql-indexes.sql %COUGAAR_INSTALL_PATH%\csmart\data\database\new\scripts\creatInd.sql


ECHO Dropping tables from database.
mysql -u%1 -p%2 %3 < %COUGAAR_INSTALL_PATH%\csmart\data\database\new\scripts\dropTab.sql
