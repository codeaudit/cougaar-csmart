...
COPY /b %COUGAAR_INSTALL_PATH%\csmart\data\database\headers\cfw_oplan_header.csv+%COUGAAR_INSTALL_PATH%\csmart\data\database\raw_data\cfw_oplan_data.csv %COUGAAR_INSTALL_PATH%\csmart\data\database\csv\cfw_oplan.csv
COPY /b %COUGAAR_INSTALL_PATH%\csmart\data\database\headers\cfw_oplan_activity_header.csv+%COUGAAR_INSTALL_PATH%\csmart\data\database\raw_data\cfw_oplan_activity_data.csv %COUGAAR_INSTALL_PATH%\csmart\data\database\csv\cfw_oplan_activity.csv
COPY /b %COUGAAR_INSTALL_PATH%\csmart\data\database\headers\cfw_oplan_loc_header.csv+%COUGAAR_INSTALL_PATH%\csmart\data\database\raw_data\cfw_oplan_loc_data.csv %COUGAAR_INSTALL_PATH%\csmart\data\database\csv\cfw_oplan_loc.csv
COPY /b %COUGAAR_INSTALL_PATH%\csmart\data\database\headers\cfw_oplan_og_attr_header.csv+%COUGAAR_INSTALL_PATH%\csmart\data\database\raw_data\cfw_oplan_og_attr_data.csv %COUGAAR_INSTALL_PATH%\csmart\data\database\csv\cfw_oplan_og_attr.csv
