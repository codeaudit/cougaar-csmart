...
SELECT OPLAN_ID,OPERATION_NAME,PRIORITY,MIN_PLANNING_OFFSET,START_OFFSET,END_OFFSET
INTO OUTFILE ":cip/csmart/data/database/raw_data/oplan_data.csv" 
FIELDS TERMINATED BY ',' 
OPTIONALLY ENCLOSED BY '"' 
LINES TERMINATED BY ",\n" FROM oplan;

SELECT OPLAN_ID,ORG_ID,COMPONENT_ID,START_CDAY,ATTRIBUTE_NAME,END_CDAY,ATTRIBUTE_VALUE
INTO OUTFILE ":cip/csmart/data/database/raw_data/oplan_agent_attr_data.csv" 
FIELDS TERMINATED BY ',' 
OPTIONALLY ENCLOSED BY '"' 
