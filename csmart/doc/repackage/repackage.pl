...
sub xconvert_abbrev {
    ...
    # Is this being used?
    s/^occ\./org\.cougaar\.tools\.csmart\./;
    s/^ui\./org\.cougaar\.tools\.csmart\.ui\./;
    s/^uic\./org\.cougaar\.tools\.csmart\.ui\.component\./;
    s/^prop\./org\.cougaar\.tools\.csmart\.core\.property\./;
    s/^abcold\./org\.cougaar\.tools\.csmart\.societies\.abcsociety\./;
    s/^abcnew\./org\.cougaar\.tools\.csmart\.societies\.abc\./;
    s/^scalold\./org\.cougaar\.tools\.csmart\.scalability\./;
    s/^scalnew\./org\.cougaar\.tools\.csmart\.societies\.scalability\./;
    $_;
}
