...
//     assertEquals("Test AssetData", "org.cougaar.planning.plugin.asset.AssetDataPlugin", gc.getName());

//     gc = (ComponentData)children[1];
//     assertEquals("Test AssetReport", "org.cougaar.planning.plugin.asset.AssetReportPlugin", gc.getName());
