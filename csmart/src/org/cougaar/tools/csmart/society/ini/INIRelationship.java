...
public class INIRelationship extends ConfigurableComponent implements Serializable {
  ...
  public INIRelationship (RelationshipData relationship, int index){
