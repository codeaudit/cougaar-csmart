  ...
  implements SocietyComponent, PropertyListener, ModificationListener
{
  ...
  public void initProperties() {
    ...
    ArrayList experimentValues = new ArrayList(1);
    experimentValues.add(new IntegerRange(1, 3));
    propLevels.setExperimentValues(experimentValues);
    ...
    experimentValues = new ArrayList(1);
    experimentValues.add(new IntegerRange(1, 4));
    propCPL.setExperimentValues(experimentValues);
