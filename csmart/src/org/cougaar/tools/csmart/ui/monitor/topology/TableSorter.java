...
public class TableSorter extends AbstractTableModel {
  ...
  /**
   * Reallocate indices needed for sorting.
   * If the number of columns has changed, then fireTableStructureChanged,
   * otherwise fireTableChanged; this has the effect of preserving the
   * user's changes (i.e. column reordering) unless they must be overwritten
   * to display new data.
   */

  public void updateModel() {
    reallocateIndexes();
    if (nColumns != model.getColumnCount()) {
