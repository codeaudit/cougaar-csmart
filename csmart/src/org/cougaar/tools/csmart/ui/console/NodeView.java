...
// created from the new CSMARTConsole code
public class NodeView extends JInternalFrame {
  ...
  public NodeView(NodeModel model) {
    ...
    // TODO: this was a pointer to CSMARTConsole
    // and needs to be replaced appropriately
    console = null;
