  ...
  implements NewRolesPG, Cloneable
{
  ...
  public final static class DQ extends RolesPGImpl implements org.cougaar.planning.ldm.dq.NewHasDataQuality {
   public DQ() {
    super();
   }
  ...
  public final org.cougaar.planning.ldm.dq.DataQuality getDataQuality() { return RolesPGImpl.this.getDataQuality(); }
    public Class getPrimaryClass() {
      return primaryClass;
    }
    public String getAssetGetMethod() {
