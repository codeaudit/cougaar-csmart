  ...
  implements NewSimpleInventoryPG, Cloneable
{
  ...
  public final static class DQ extends SimpleInventoryPGImpl implements org.cougaar.planning.ldm.dq.NewHasDataQuality {
   public DQ() {
    super();
   }
  ...
  public final org.cougaar.planning.ldm.dq.DataQuality getDataQuality() { return SimpleInventoryPGImpl.this.getDataQuality(); }
    public Class getPrimaryClass() {
      return primaryClass;
    }
    public String getAssetGetMethod() {
